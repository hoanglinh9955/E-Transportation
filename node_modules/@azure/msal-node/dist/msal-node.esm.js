...
const networkRequestViaProxy = (url, proxyUrlString, httpMethod, options, agentOptions, timeout) => {
...
const networkRequestViaHttps = (url, httpMethod, options, agentOptions, timeout) => {
